package yxinfo.core.framework.service.dal;
...
public class PagePlug implements Interceptor {
    ...
    private void getPage( Object model, String sql, MetaObject metaStatementHandler, Invocation invocation, MappedStatement mappedStatement, BoundSql boundSql )
    ...
    private Object processPageing( Page page, String sql, MetaObject metaStatementHandler, Invocation invocation, MappedStatement mappedStatement, BoundSql boundSql )
